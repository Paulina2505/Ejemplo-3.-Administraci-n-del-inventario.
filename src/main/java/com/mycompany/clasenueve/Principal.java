...
public class Principal {
    ...
    private static int individuos = 50;
    private static int genes = 5;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("COSTO EN DOLARES: "+fitness(decimales[papaMenor()]));
        System.out.println("NÚMERO DE BICICLETAS: "+decimales[papaMenor()]);
    }
    ...
    public static double fitness(int x) {if (x > 0) return (4860/x)+(15*x)+750000; else return (4860/1)+(15*x)+750000;}
